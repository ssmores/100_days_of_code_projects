...
10. If you find a great, helpful resource that others would benefit from, either submit a Pull Request to add it to the repo, or just tweet at ka11away (see info below).
...
* I forked the repo, but my commits aren't showing in my GitHub contributions (since it was a forked repo). I've since created another repo to handle that. 
